...
namespace SimpleUIFramework
{
    ...
    public static class Log
    {
        ...
        static Log()
        {
            ...
            //日志文件路径
            IConfigManager configMgr = new ConfigManagerByJson(SysDefine.SYS_PATN_LOG_CONFIG_INFO);
            ...
            string strPCTruePath = Application.dataPath  + configMgr.AppSetting[JSON_CONFIG_LOG_PATH] + ".txt";
            ...
            {
                _LogPath = UnityEngine.Application.persistentDataPath + "//" + JSON_CONFIG_LOG_DEFAULT_PATH; // todo 测试"/AppLog/" + configMgr.AppSetting[JSON_CONFIG_LOG_PATH] + ".txt";
            }
